...
async def main_async() -> None:
    ...
    records = load_cached_split(data_dir, "train")
    scenarios = scenarios_from_records(records, split="train")
    ...
    groups = await art.gather_trajectory_groups(
        (
            art.TrajectoryGroup(rollout_retail(model, scenario) for _ in range(args.rollouts_per_scenario))
